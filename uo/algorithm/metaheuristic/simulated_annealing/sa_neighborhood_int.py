"""
The :mod:`~uo.algorithm.metaheuristic.simulated_annealing.sa_neighborhood_int` contains 
class :class:`~uo.algorithm.metaheuristic.simulated_annealing.sa_neighborhood_int.SaNeighborhoodInt`, 
that represents Simulated Annealing neighborhood support for integer-encoded solutions.
"""
...
class SaNeighborhoodInt(SaNeighborhood):
    """
    Neighborhood structure for integer solutions for Simulated Annealing.
    ...
    def string_rep(self, delimiter: str, indentation: int = 0, indentation_symbol: str = '', group_start: str = '{',
        ...
        """
        return f'SaNeighborhoodInt{group_start}dimension={self.dimension}{delimiter}k={self.k}{group_end}'
